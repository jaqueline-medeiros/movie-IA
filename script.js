async function getMovies(){
  const options = {
    ...
    headers: {
      ...
      Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI3Y2NmMTNmNWY3Y2NmMDMxMGUxZmIzNGYwYmI5ZGRiYiIsInN1YiI6IjY0ZTNiZjAxYzkwNTRmMDBjNDBlYjc4OSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.6J49sFG4Eb2s4ka0Zd9A9bTDnzy-z_60JlDVoCBYF2w'
    }
  };
...
function createMovieLayout({
  id, title, stars, image, time, year
}) {
  return `
  <div class="movie">
          <div class="title">
...
async function start() {
  ...
  // pegar informações extras de 3 filmes
